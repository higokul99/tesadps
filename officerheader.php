...
<head>
    ...
    <title>TESA Officer Panel</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin_index.html">T.E.S.A Officer Panel</a>
            </div>
                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div">
                            ...
                            $q = mysql_query("select image from offreg where off_id = '".$off_id."'");
                            $row = mysql_fetch_array($q);
                            if ($row['image'] != "")
                            {
                               echo "<img src=userdocs/".$off_id."_oprofilepic.jpg height='50' width='50'>";
                            }
                            else
                            {
...
<!-- Approval session -->
                        ...
                        <a href="#"><i class="fa fa-desktop "></i>Approval<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="o_ap_user.php"><i class="fa fa-toggle-on"></i>User </a>
                            </li>
                            <!-- <li>
                                <a href="o_ap_vehdoc.php"><i class="fa fa-bell "></i>User Doc</a>
                            </li> -->
...
<!-- Approval session -->
                    ...
                    <li>
                        <a href="o_viewvo.php"><i class="fa fa-flash "></i>Vehicle Officers</a>
                        
                    </li>
                     

                    <li>
                        <a href="o_viewtp.php"><i class="fa fa-anchor "></i>Traffic Police</a>
                    </li>
                    <li>
                        <a href="o_viewuser.php"><i class="fa fa-key "></i>Users</a>
                    </li>
                         <!-- <ul class="nav nav-second-level"> -->
                            <li>
                                <a href="o_updateprofile.php"><i class="fa fa-toggle-on"></i>My Account </a>
                            </li>
