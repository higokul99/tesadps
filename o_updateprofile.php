...
<tr>
    ...
    <td>
        <input style="width: 100%;" type="text" name="login_id" placeholder="<?php echo $bill['off_id']; ?>" readonly>
    </td>
</tr>
<tr>
    <td>
...
<tr>
    ...
    <td>
        <input style="width: 100%;" type="text" name="alph" placeholder="<?php echo $bill['alt_ph']; ?>" readonly>
    </td>
</tr>
<tr>
    <td>
...
$sql="SELECT * FROM offreg WHERE off_id='".$id."'";
$result=mysql_query($sql);
$bill=mysql_fetch_assoc($result);
?>
...
<tr>
    ...
    <td>
        <input style="width: 100%;" type="file" name="idcard" placeholder="">
    </td>
</tr>
<tr>
    <td>
...
<tr>
        ...
        <td>
            <input style="width: 100%;" type="date" name="dob" placeholder="" >
        </td>
</tr>
<tr>
                <td>
...
<tr>
    ...
    <td>
        <input style="width: 100%;" type="text" name="ph" placeholder="" >
    </td>
</tr>
<tr>
    <td>
    ...
    <td>
        <input style="width: 100%;" type="text" name="alph" placeholder="" >
    </td>
</tr>
<tr>
    <td>
    ...
    <td>
        <input style="width: 100%;" type="textarea" name="address" placeholder="" >
    </td>
</tr>
</tbody></table>
    <input type="submit" name="o_update" value="Update">
</form>
                </div>
