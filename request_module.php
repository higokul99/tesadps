    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin_index.html">T.E.A user Panel</a>
            </div>
...
<a href="#"><i class="fa fa-desktop "></i>Add Details<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="Off_approve_user.php"><i class="fa fa-toggle-on"></i>Update Profile </a>
                            </li>
                            <li>
                                <a href="off_approve_veh_doc.html"><i class="fa fa-bell "></i>Update Vehicle</a>
                            </li>
                              <li>
                                <a href="x.html"><i class="fa fa-circle-o "></i>Request Drowsiness Module</a>
                            </li>
                             <!--<li>
