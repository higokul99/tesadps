    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin_index.html">T.E.A Officer Panel</a>
            </div>
                    ...
                    <li>
                        <div class="user-img-div">
                            ...
                            <div class="inner-text">
                                <?php
                                session_start();
                                $off_id=$_SESSION['username'] ;
                                echo "<span>".$off_id."</span>";
                                ?>
                            <br />
                                <small>Online</small>
                            </div>
...
<a href="#"><i class="fa fa-desktop "></i>Approval<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="Off_approve_user.php"><i class="fa fa-toggle-on"></i>Approve User</a>
                            </li>
                            <li>
...
<?php 
                        ...
                        viewtableforuserAP("select * from register where user_status='0'","APuser");
