    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin_index.html">D.P.S Admin Panel</a>
            </div>
...
<!-- Approval session -->
                        ...
                        <a href="#"><i class="fa fa-desktop "></i>Approval<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="adm_v_ap.php"><i class="fa fa-toggle-on"></i>Vehicle Officers</a>
                            </li>
                            <li>
                                <a href="adm_tp_ap.php"><i class="fa fa-bell "></i>Traffic Police</a>
                            </li>
                              <!--<li>
                                <a href="admin_progress.html"><i class="fa fa-circle-o "></i>Traffic Police List</a>
                            </li>
                             <li>
                                <a href="admin_buttons.html"><i class="fa fa-code "></i>Buttons</a>
                            </li>
                             <li>
...
<!-- Approval session -->
                     ...
                     <li>
                        <a href="#"><i class="fa fa-yelp "></i>Reports<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="admin_invoice.html"><i class="fa fa-coffee"></i>r1</a>
                            </li>
                            <li>
                                <a href="admin_pricing.html"><i class="fa fa-flash "></i>r2</a>
                            </li>
                    ...
                    <li>
                        <a href="adm_vo_list.php"><i class="fa fa-flash "></i>Vehicle Officers</a>
                    ...
                    <li>
                        <a href="adm_tp_list.php"><i class="fa fa-anchor "></i>Traffic Police</a>
                    </li>
                    <li>
                        <a href="adm_user_list.php"><i class="fa fa-key "></i>Users</a>
                    </li>
                     <!-- <li>
...
else
{
 ...
 while ($row = mysql_fetch_row($result))
 {
  ...
  echo "<td><a href='adm_tp_ap.php?id=$idval&op=APtp'>tick</a></td>";
